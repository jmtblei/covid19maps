          ...
          <Toolbar>
            ...
            >
              ...
              <Menu
                ...
                onClose={toggleClose}
              >
                <MenuItem onClick={toggleClose} component={Link} to="/">Recent News</MenuItem>
                <MenuItem onClick={toggleClose} component={Link} to="/cases-all-time">Confirmed Cases (All Time)</MenuItem>
