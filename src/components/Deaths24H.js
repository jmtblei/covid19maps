...
export default () => {
    ...
    const continentsum = d3Array.rollup(arrangeAllData(countriesByTodayDeaths), v => d3.sum(v, d => d.newdeaths), v => v.continent, v => v.country, v => v.globalpercent, v => v.countryflag);
    // const continentsum = d3Array.rollup(countryData, v => d3.sum(v, d => d.todayDeaths), v => v.continent, v => v.country, v => v.countryInfo);
    ...
    const frameProps = { 
        ...
        tooltipContent: d => (
            ...
            <h5 style={{margin:5}}>Total confirmed new deaths: {d.value}</h5>
            </>
            : 
            <>
            <h5 style={{margin:5}}>Country: {d.parent.parent[0]}</h5>
            <h5 style={{margin:5}}>Total confirmed new deaths: {d.value}</h5>
            <h5 style={{margin:5}}>% Global new deaths: {d.parent[0]}%</h5>
                    ...
                    <React.Fragment>
                        <div>
                            <Collapse in={expand}>
                                ...
                                >
                                    <AlertTitle>
                                        These are countries/regions with confirmed deaths in the past 24 hours.
                                    </AlertTitle>
                                    <strong>
                                    ...
                                    <DialogContent dividers={scroll === 'paper'}>
                                        <TableContainer component={Paper}>
                                            <Table aria-label="simple table">
                                                ...
                                                <TableBody>
                                                    {arrangeAllData(countriesByTodayDeaths).map((data, index) => {
                                                        return (
                                                            <>
                                                                <TableRow key={index}>
