...
export default () => {
    ...
    const frameProps = { 
        ...
        tooltipContent: d => (
            ...
            <h5 style={{margin:5}}>{Number(d.value).toLocaleString()} Total cases</h5>
            <h5 style={{margin:5}}>{parseFloat(worldChange(d.value, hierarchydata.value))}% Global cases</h5>
            </>
            : 
            <>
            <h3 style={{margin:5}}>{d.parent.parent[0]}</h3>
            <h5 style={{margin:5}}>{Number(d.value).toLocaleString()} Confirmed cases</h5>
            <h5 style={{margin:5}}>{Number(d.parent[0]).toLocaleString()}% Global cases</h5>
                                                        ...
                                                        return (
                                                            <>
                                                                <TableRow key={index}>
                                                                    ...
                                                                    <TableCell align="right">{Number(data.totalconfirmed).toLocaleString()}</TableCell>
