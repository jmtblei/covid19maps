                    ...
                    <React.Fragment>
                        <div>
                            <Collapse in={expand}>
                                ...
                                >
                                    <AlertTitle>
                                        These are the top countries worldwide (max. 50) with the most confirmed recoveries 
                                    </AlertTitle>
                                    <strong>
                                        Mouse over data points for additional details.
                                    </strong>
                        ...
                        <div className="svg-menu">
                                        ...
                                        <TableContainer component={Paper}>
                                            <Table aria-label="simple table">
                                                <TableHead>
                                                    ...
                                                    <TableBody>
                                                        {arrangeAllData(countriesByRecovered.slice(0, 50)).map((data, index) => {
                                                            return (
                                                                <>
                                                                    <TableRow key={index}>
                                                                        <TableCell component="th" scope="row">
                            ...
                            <div className="transform-container">
                                <TransformComponent>
                                    <Svg width={window.innerWidth * .8} height={window.innerHeight * .7} className="svg-content">
                                        <Pack
                                            data={{children: arrangeAllData(countriesByRecovered.slice(0, 50))}}
                                            sum={datum => datum.recovered}
                                            size={[window.innerWidth * .8, (window.innerHeight * .65)]}
                                            includeRoot={false}
                                            padding={5}
                                        >
                                            ...
                                            <>
                                                ...
                                                <Tooltip title={
                                                    <Fragment>
                                                        <h2>{data.country}</h2>
                                                        <h2>Total confirmed recoveries: {data.recovered}</h2>
                                                        <h2>% Global recoveries: {data.globalpercent.toFixed(4)}%</h2>
                                                        <img src={data.countryflag}/>
                                                    </Fragment>
                                                }>
                                                    <Circle
